...
def main():
    ...
    tb = TensorBoardWrapper(myGene_valid, nb_steps=valid_steps, log_dir='./logs/%d'%log_id, histogram_freq=10, batch_size=1, write_graph=True, write_grads=True, write_images=False)
